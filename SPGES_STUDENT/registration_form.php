										  		...
										  		<table class="table-condensed text-nowrap" width="100%">
												    <tr>
												      <td colspan='5'><u><b>PERSONAL DATA</b></u></td>
															...
															<input type="hidden" name="txtstudNo" class="form-control input-sm" id="txtstudNo" value='<?php echo $studNo; ?>' disabled>
															<?php
																require ('conn.php');
																...
																if(mysqli_num_rows($Result) > 0){
																	while($row = mysqli_fetch_array($Result)){
																		...
																		$SResult = mysqli_query($conn, "SELECT * FROM tbl_curriculum WHERE schoolyear = '$cursy'");
															...
															?>
															<input type="hidden" name="txtstudNo" class="form-control input-sm" id="txtcursem" value='<?php echo $cursem; ?>' disabled>
															<input type="hidden" name="txtstudNo" class="form-control input-sm" id="txtcursy" value='<?php echo $cursy; ?>' disabled>
															<input type="hidden" name="txtstudNo" class="form-control input-sm" id="txtcurID" value='<?php echo $curID; ?>' disabled>
												    </tr>
											...
											<div class="tab-pane fade" role="tabpanel" id="stepper-step-8">
												...
												<table class="table-condensed  text-nonwrap" width=50%>
													...
													<tr style='font-size:13px;'>
														<td>
															<div class="idpic">
																<img src="SPGES_ADMIN/idpic/user.png" id="output_image">
															</div>
														</td>
													</tr>
												</table>
