<!DOCTYPE html>
	<html lang="en">
		...
		<body class="hold-transition sidebar-mini layout-fixed">
									...
									<div class="col-10">
										<div class="card">
											<div class="card-header">
												<div class="row">
													<div class="col-2">
														<button type="button" class="btn btn-primary btn-block btn-sm" id="addCur"><i class="fa fa-plus"></i>  ADD</button>
													</div>
													<div class="col-10"></div>
												</div>
											</div>

											<div class="card-body" id="cur_content">
			...
			<!-- modal -->
				<div class="modal fade" id="modalNewCur">
							...
							<div class="modal-body">
								<form id="quickForm">
									<div class="form-group">
										<label for="sltSy">School Year</label>
									...
									<div class="form-group">
										<label for="txtCMO">Curriculum.</label>
										<input type="text" name="txtcurr" class="form-control" id="txtcurr" placeholder="Enter Curriculum">
									</div>
								</div>

								<div class="modal-footer justify-content-between">
									<button type="button" class="btn btn-default btn-md" data-dismiss="modal">Close</button>
									<button type="submit" class="btn btn-primary btn-md" id="btnSaveCur">Save</button>
								</div>
							</form>
						</div>
					</div>
				...
				<div class="modal fade" id="modalEditCur">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
							...
							<div class="modal-body">
								<form>
									...
									<div class="form-group">
										<label for="txtCMO">Curriculum.</label>
										<input type="text" name="etxtcurr" class="form-control" id="etxtcurr" placeholder="Enter Curriculum">
									</div>
							</div>

							<div class="modal-footer justify-content-between">
								<button type="button" class="btn btn-default btn-md" data-dismiss="modal">Close</button>
								<button type="button" class="btn btn-primary btn-md" id="btnEditCur">Save</button>
							</div>
							</form>
						</div>
					</div>
				...
				<div class="modal fade" id="modalDelCur">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
							...
							<div class="modal-footer justify-content-between">
								<button type="button" class="btn btn-default btn-md" data-dismiss="modal">Close</button>
								<button type="button" class="btn btn-primary btn-md" id="btnDelCur">Yes</button>
							</div>
