<!DOCTYPE html>
	<html lang="en">
		...
		<body class="hold-transition sidebar-mini layout-fixed">
				...
				<div class="sidebar">
					<nav class="mt-2"  style="color:white;">
						<ul class="nav nav-pills nav-compact nav-child-indent nav-sidebar flex-column" role="menu" data-accordion="false">
							...
							<li class="nav-item">
								<a href="semester.php" class="nav-link actvive">
								...
								<div class="col-8">
									<div class="card">
										<div class="card-header">
											<div class="row">
												<div class="col-2">
													<button type="button" class="btn btn-primary btn-block btn-sm" id="addSemester"><i class="fa fa-plus"></i>  ADD</button>
												</div>
												<div class="col-10"></div>
											</div>
										</div>
										<div class="card-body" id="sem_content">
			...
			<!-- modal -->
				<div class="modal fade" id="modalNewSem">
							...
							<div class="modal-body">
								<form id="quickForm">
									<div class="form-group">
										...
										<input type="text" name="txtSemester" class="form-control" id="txtSemester" placeholder="Enter Semester">
									</div>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form id="EditForm">
									<div class="form-group">
										<label for="etxtSemester">Semester</label>
										<input type="text" name="etxtSemester" class="form-control" id="etxtSemester" placeholder="Enter Semester">
									</div>
							...
							<div class="modal-footer justify-content-between">
								<button type="button" class="btn btn-default btn-md" data-dismiss="modal">Close</button>
								<button type="button" class="btn btn-primary btn-md" id="btnEditSem">Save</button>
							</div>
							</form>
						</div>
					</div>
				...
				<div class="modal fade" id="modalDelSem">
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-footer justify-content-between">
								<button type="button" class="btn btn-default btn-md" data-dismiss="modal">Close</button>
								<button type="button" class="btn btn-primary btn-md" id="btnDelSem">Yes</button>
							</div>
