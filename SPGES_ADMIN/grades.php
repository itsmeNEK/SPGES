					...
					<div class="container-fluid">
						<div class="card">
							<div class="card-header">
								<div class="row">
									<div class="col-2">
										<button type="button" class="btn btn-primary btn-block btn-sm" id="btngrades"><i class="fa fa-plus"></i>  ADD </button>
									</div>
							...
							<form id="quickForm">
								<table class="table text-nowrap">
									<tr>
										<td  style="vertical-align: middle; " width="5%" algin="center">Stud No.</td>
										<td>
											<input type="text" name="txtStud" class="form-control form-control-sm" id="txtStud">
										</td>
										<td  style="vertical-align: middle; "  width="5%" algin="center">Semester</td>
										<td>
										...
										<td  style="vertical-align: middle; "  width="10%">School Year</td>
										<td>
										...
										<td width="10%">
											<button type="submit" class="btn btn-primary btn-sm" id="btngrade_search">
							...
							<div class="card-body" id="stud_grade_details" >
