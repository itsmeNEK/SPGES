	...
	?>
		...
		<body class="hold-transition sidebar-mini layout-fixed">
						...
						<ul class="nav nav-pills nav-child-indent nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
							...
							<li class="nav-item menu-open">
								...
								<ul class="nav nav-treeview">
									...
									<li class="nav-item">
										<a href="report_checklist.php" class="nav-link  active">
			...
			<div class="content-wrapper">
				<div class="content-header">
					<div class="container-fluid">
						<div class="row mb-2">
							<div class="col-sm-6">
								<h1 class="m-0">Curriculum Checklist</h1>
							</div>
								...
								<div class="card">
									<div class="card-header">
										<div class="row">
											...
											<div class="col-2">
												<button type="button" class="btn btn-primary btn-block btn-sm" id="btndecrypt"><i class="fas fa-eye"></i>  Decrypt</button>
											</div>
										</div>
									</div>
									<div class="card-body">
										<form id="quickForm">
											<table class="table text-nowrap">
												<tr>
													...
													<td width="10%">
														<a class='btn btn-primary btn-sm' id="btnfilter" >
															<span class='fas fa-filter'></span>
															<b>&nbsp; Filter &nbsp;</b>
														</a>
													</td>
													<td width="10%">
														<a class='btn btn-success btn-sm' id="btnprint" >
			...
			<footer class="main-footer">
				...
				<div class="modal fade" id="modaldecrypt">
							...
							<div class="modal-body">
								<form id="quickForm">
									...
									<div class="form-group">
										<label for="txtcode">Decryption Code</label>
										<input type="password" name="txtcode" class="form-control" id="txtcode" placeholder="Code">
									</div>
								</div>

								<div class="modal-footer justify-content-between">
									<button type="button" class="btn btn-default btn-md" data-dismiss="modal">Close</button>
									<button type="submit" class="btn btn-primary btn-md" id="btndecrypt_code">Decrypt</button>
								</div>
							</form>
						</div>
					</div>
