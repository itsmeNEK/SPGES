<!DOCTYPE html>
	<html lang="en">
		...
		<body class="hold-transition sidebar-mini layout-fixed">
								...
								<div class="col-8">
									<div class="card">
										<div class="card-header">
											<div class="row">
												<div class="col-2">
													<button type="button" class="btn btn-primary btn-block btn-sm" id="addSy"><i class="fa fa-plus"></i>  ADD</button>
												</div>
												<div class="col-10"></div>
											</div>
										</div>
										<div class="card-body" id="sy_content">
			...
			<!-- modal -->
			<div class="modal fade" id="modalNewSy">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form id="quickForm">
								<div class="form-group">
									<label for="txtSy">School Year</label>
									<input type="text" name="txtSy" class="form-control" id="txtSy" placeholder="Enter School Year">
								</div>
						...
						<div class="modal-footer justify-content-between">
							...
							<button type="submit" class="btn btn-primary btn-md" id="btnSaveSy">Save</button>
						</div>
						</form>
					</div>
				</div>
			...
			<div class="modal fade" id="modalEditSy">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
						...
						<div class="modal-body">
							<form id="quickForm">
								<div class="form-group">
									<label for="etxtSy">School Year</label>
									<input type="text" name="etxtSy" class="form-control" id="etxtSy" placeholder="Enter Semester">
								</div>
						...
						<div class="modal-footer justify-content-between">
							<button type="button" class="btn btn-default btn-md" data-dismiss="modal">Close</button>
							<button type="button" class="btn btn-primary btn-md" id="btnEditSy">Save</button>
						</div>
						</form>
					</div>
				</div>
			...
			<div class="modal fade" id="modalDelSy">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
						...
						<div class="modal-footer justify-content-between">
							<button type="button" class="btn btn-default btn-md" data-dismiss="modal">Close</button>
							<button type="button" class="btn btn-primary btn-md" id="btnDelSy">Yes</button>
						</div>
