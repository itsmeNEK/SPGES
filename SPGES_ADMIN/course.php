<!DOCTYPE html>
	<html lang="en">
		...
		<body class="hold-transition sidebar-mini layout-fixed">
										...
										<div class="card">
											<div class="card-header">
												<div class="row">
													...
													<div class="col-2">
														<button type="button" class="btn btn-primary btn-block btn-sm" id="addCourse"><i class="fa fa-plus"></i>  ADD</button>
													</div>
												</div>
											</div>
											<?php
			...
			<!-- modal -->
				<div class="modal fade" id="modalNewCourse">
							...
							<div class="modal-body">
								<form id="quickForm">
									<div class="form-group">
										<label for="sltYear">Year Level</label>
										<select class="form-control" name="sltYear" id="sltYear">
											<option selected="selected" disabled>Select Year Level</option>
											<?php
												require ('conn.php');

												$YResult = mysqli_query($conn, "SELECT * FROM tbl_year");
									...
									<div class="form-group">
										...
										<select class="form-control" name="sltSem" id="sltSem">
									...
									<div class="form-group">
										<label for="txtcode">Course Code</label>
										<input type="text" name="txtcode" class="form-control" id="txtcode" placeholder="Enter Course Code">
									</div>

									<div class="form-group">
										<label for="txttitle">Course Title</label>
										<input type="text" name="txttitle" class="form-control" id="txttitle" placeholder="Enter Title">
									</div>

									<div class="form-group">
										<label for="txtunit">Units</label>
										<input type="text" name="txtunit" class="form-control" id="txtunit" placeholder="Enter Units">
									</div>
								...
								<div class="modal-footer justify-content-between">
									...
									<button type="submit" class="btn btn-primary btn-md" id="btnSaveCourse">Save</button>
								</div>
							</form>
						</div>
					</div>
				...
				<div class="modal fade" id="modalEditCourse">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
							...
							<div class="modal-body">
								<form>
									<div class="form-group">
										<label for="esltYear">Year Level</label>
							...
							<div class="modal-footer justify-content-between">
								<button type="button" class="btn btn-default btn-md" data-dismiss="modal">Close</button>
								<button type="button" class="btn btn-primary btn-md" id="btnEditCourse">Save</button>
							</div>
							</form>
						</div>
					</div>
				...
				<div class="modal fade" id="modalDelCourse">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
							...
							<div class="modal-footer justify-content-between">
								<button type="button" class="btn btn-default btn-md" data-dismiss="modal">Close</button>
								<button type="button" class="btn btn-primary btn-md" id="btnDelCourse">Yes</button>
							</div>
