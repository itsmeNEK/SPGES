									...
									<div class="col-8">
										<div class="card">
											<div class="card-header">
												<div class="row">
													<div class="col-2">
														<button type="button" class="btn btn-primary btn-block btn-sm" id="addUser"><i class="fa fa-plus"></i>  ADD</button>
													</div>
													<div class="col-10"></div>
												</div>
											</div>

											<div class="card-body" id="user_content">
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form id="quickForm">
								<div class="row">
									<div class="col-6">
										<div class="form-group">
											...
											<input type="text" name="txtFname" class="form-control" id="txtFname" placeholder="Enter Firstname">
										</div>
									</div>
									...
									<div class="col-6">
										<div class="form-group">
											...
											<input type="text" name="txtLname" class="form-control" id="txtLname" placeholder="Enter Lastname">
										</div>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<input type="text" name="txtUname" class="form-control" id="txtUname" placeholder="Enter Username">
								</div>

								<div class="form-group">
									<label for="txtPass">Password</label>
									<input type="password" name="txtPass" class="form-control" id="txtPass" placeholder="Enter Password">
								</div>
						...
						<div class="modal-footer justify-content-between">
							...
							<button type="submit" class="btn btn-primary btn-md" id="btnSaveUser">Save</button>
						</div>
						</form>
					</div>
				</div>
			...
			<div class="modal fade" id="modalEditUser">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form>
								<div class="row">
									<div class="col-6">
										<div class="form-group">
											<label for="etxtFname">Firstname</label>
											<input type="text" name="etxtFname" class="form-control" id="etxtFname" placeholder="Enter Firstname">
										</div>
									</div>

									<div class="col-6">
										<div class="form-group">
											<label for="etxtLname">Lastname</label>
											<input type="text" name="etxtLname" class="form-control" id="etxtLname" placeholder="Enter Lastname">
										</div>
									</div>
								</div>

								<div class="form-group">
									<label for="etxtUname">Username</label>
									<input type="text" name="etxtUname" class="form-control" id="etxtUname" placeholder="Enter Username">
								</div>

								<div class="form-group">
									<label for="etxtPass">Password</label>
									<input type="password" name="etxtPass" class="form-control" id="etxtPass" placeholder="Enter Password">
								</div>
						...
						<div class="modal-footer justify-content-between">
							<button type="button" class="btn btn-default btn-md" data-dismiss="modal">Close</button>
							<button type="button" class="btn btn-primary btn-md" id="btnEditUser">Save</button>
						</div>
						</form>
					</div>
				</div>
			...
			<div class="modal fade" id="modalDelUser">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-footer justify-content-between">
							<button type="button" class="btn btn-default btn-md" data-dismiss="modal">Close</button>
							<button type="button" class="btn btn-primary btn-md" id="btnDelUser">Yes</button>
						</div>
